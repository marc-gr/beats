...
type Result struct {
	...
	ShortcutPath       string    `osquery:"shortcut_path"`                       // Full path to the shortcut file (.lnk)
	ShortcutTargetPath string    `osquery:"shortcut_target_path"`                // Target path that the shortcut points to
	ShortcutAumid      string    `osquery:"shortcut_aumid"`                      // Application User Model ID (AUMID) for the shortcut
	ShortcutProgramId  string    `osquery:"shortcut_program_id"`                 // Program identifier associated with the shortcut
}
