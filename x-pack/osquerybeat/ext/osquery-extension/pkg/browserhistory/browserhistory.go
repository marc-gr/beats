...
func init() {
	elasticbrowserhistory.RegisterGenerateFunc(generateFunc)
}

func generateFunc(ctx context.Context, queryContext table.QueryContext, log *logger.Logger) ([]elasticbrowserhistory.Result, error) {
	once.Do(initParsers)
